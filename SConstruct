...
external(env,'openmesh',libpath=[build_root+'/OpenMesh-2.0/build/Build/lib/OpenMesh'],cpppath=[build_root+'/OpenMesh-2.0/src', build_root+'/gmm-4.2/include'],flags=['GEODE_OPENMESH'],libs=['OpenMeshCore','OpenMeshTools'],requires=['boost_link'],headers=['OpenMesh/Core/Utils/Endian.hh'])
